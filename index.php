...
<header>    
  <nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color:#2222FF;">
      <a class="navbar-brand">
          <a href="https://mhpinformatica.netlify.app/index.html" title="Página Inicial"><img class="logobarra" src="src/logonova.jpg" width="130px" height="80px" class="d-inline-block align-top"></a>
        </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active">
                <a class="nav-link" href="https://mhpinformatica.netlify.app/index.html" title="Página Inicial" style="color: white;">Página Inicial<span class="sr-only">(current)</span></a>
              </li>
             
              <li class="nav-item">
                <a class="nav-link" style="color: white;" href="https://mhpinformatica.netlify.app/downloads.html">Ferramentas</a>
                  <li class="nav-item">
                    <a class="nav-link" href="https://mhpinformatica.netlify.app/sobre.html" style="color: white;" title="Informações do Site">Sobre</a>
                  </li>
                </li>
            </ul>
          </div>
